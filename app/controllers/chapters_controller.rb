class ChaptersController < ApplicationController
  ...
  def draft_flash_message(work)
    flash[:notice] = work.posted ? ts("This is a draft chapter in a posted work. It will be kept unless the work is deleted.") : ts("This is a draft chapter in an unposted work. The work will be <strong>automatically deleted</strong> on #{view_context.date_in_zone(work.created_at + 1.month, 'UTC')}.").html_safe
  end
